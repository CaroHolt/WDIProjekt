...
public class PopularityFuserAverage extends AttributeValueFuser<Byte, Sight, Attribute> {

    public PopularityFuserAverage() { super(new AverageByte<Sight, Attribute>());}
