...
public class DescriptionFuserShortestString extends AttributeValueFuser<String, Sight, Attribute> {

    public DescriptionFuserShortestString() { super(new ShortestString<Sight, Attribute>());}
