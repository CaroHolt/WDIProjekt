...
public class IR_using_linear_combination_LB {
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        new SightXMLReader().loadFromXML(new File("data/input/wikidata_deduplicated.xml"), "/sights/sight", dataGeonames);
        ...
        gsTest.loadFromCSVFile(new File("data/goldstandard/gs_wiki_geo.csv"));

        // create a matching rule
        LinearCombinationMatchingRule<Sight, Attribute> matchingRule = new LinearCombinationMatchingRule<>(0.7);
        matchingRule.activateDebugReport("data/output/debugResultsMatchingRule_LB.csv", 50000, gsTest);

        // add comparators
                // FOR NAME
        matchingRule.addComparator(new SightNameComparatorEqual(), 0.2);
        matchingRule.addComparator(new SightNameComparatorJaccard(), 0.2);
        matchingRule.addComparator(new SightNameComparatorLevenshtein(), 0.2);
        matchingRule.addComparator(new SightNameComparatorLowercaseJaccard(), 0.2);
        ...
        //matchingRule.addComparator(new SightNameComparatorNGramJaccard(), 1);
        	...
        	// FOR COORDINATES
        //matchingRule.addComparator(new SightLatitudeComparatorRound4(), 1);     
...
//		SortedNeighbourhoodBlocker<Movie, Attribute, Attribute> blocker = new SortedNeighbourhoodBlocker<>(new MovieBlockingKeyByTitleGenerator(), 1);
        ...
        blocker.collectBlockSizeData("data/output/debugResultsBlockingLB.csv", 100);
        ...
        Processable<Correspondence<Sight, Attribute>> correspondences = engine.runIdentityResolution(
        		dataOpentripmap,dataGeonames, null, matchingRule,
                blocker);
...
//		 correspondences = maxWeight.getResult();
        ...
        new CSVCorrespondenceFormatter().writeCSV(new File("data/output/opentripmap_geonames_correspondences.csv"), correspondences);
        ...
        System.out.println("Opentripmap <-> Geonames");
		...
		// Print execution time in ms Opentripmap Geonames
